...
typedef std::function<std::shared_ptr<TableDihedralForceCompute>(
...
std::shared_ptr<TableDihedralForceCompute>
...
std::shared_ptr<TableDihedralForceCompute> gpu_tf_creator(std::shared_ptr<SystemDefinition> sysdef,
                                                          unsigned int width)
    {
    return std::shared_ptr<TableDihedralForceCompute>(
        new TableDihedralForceComputeGPU(sysdef, width));
    }
#endif
