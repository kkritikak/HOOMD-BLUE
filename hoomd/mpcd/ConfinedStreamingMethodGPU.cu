...
//! Template instantiation of sphere geometry streaming
template cudaError_t confined_stream<mpcd::detail::SphereGeometry>
    (const stream_args_t& args, const mpcd::detail::SphereGeometry& geom);
